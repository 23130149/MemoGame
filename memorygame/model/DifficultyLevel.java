...
public class DifficultyLevel {
    ...
    public enum Level {
        ...
        Level(String displayName, int gridRows, int gridCols, int totalPairs,
              int timeLimitSec, float scoreMultiplier, String description) {
    ...
    public String getLevelInfo() {
        return String.format(
                "%s | %d×%d | %d cặp | %ds | x%.1f điểm",
                levelName, gridRows, gridCols, totalPairs, timeLimitSec, scoreMultiplier
        );
    }
